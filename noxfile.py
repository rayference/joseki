...
@nox_poetry.session(name="pre-commit", python="3.9")
...
def safety(session) -> None:  # type: ignore[no-untyped-def]
...
@nox_poetry.session(name="docs-build", python="3.9")
...
def docs(session: Session) -> None:
    ...
    session.install(".")
    session.install(
        "sphinx", "sphinx-autobuild", "sphinx-click", "sphinxcontrib_bibtex", "furo"
    )
