...
## [2.7.1] - Upcoming release

### Fixed

* Fix Sutherland's Law BETA constant (wrong by 12 orders of magnitude because of
  a typo).
...
* Internalize ussa1976 dependency, which is no longer maintained.
